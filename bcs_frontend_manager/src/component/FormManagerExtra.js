...
class FormManagerExtra extends Component{
    ...
    handleTestExtraUpdate = () => {
        this.setState({outfit: 'black shirt', alignment: 'catholic', politeness: 'polite',
            honestly: true, personState: 'booby'})
    };
            ...
            <div style={MainBackground} className="App">
                ...
                <form style={TableCssExtra}>
                    <TextField style={TextFieldCssExtra} label="Outfit" placeholder="Outfit"
                               name="outfit" value={this.state.outfit} onChange={this.handleChange}/><br/>
                    <TextField style={TextFieldCssExtra} label="Alignment" placeholder="Alignment"
                               name="alignment" value={this.state.alignment} onChange={this.handleChange}/><br/><br/>
                    <TextField style={TextFieldCssExtra} label="Politeness" placeholder="Politeness"
                               name="politeness" value={this.state.politeness} onChange={this.handleChange}/><br/><br/>
                    <TextField style={TextFieldCssExtra} label="Person state" placeholder="Person state"
                               name="personState" value={this.state.personState} onChange={this.handleChange}/><br/><br/>
                <InputLabel htmlFor="honestly-simple"> Honestly:
                    ...
                    <Button style={buttonStyleTest} variant="contained" color="primary"
                            onClick={this.handleTestExtraUpdate}>Test</Button>
                </form>
            </div>
